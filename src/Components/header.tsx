...
const Header: React.FC = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-cyan-500 to-blue-500 border-gray-200 dark:bg-gray-900 sticky top-0 z-50">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="/" className="flex items-center justify-start">
          <img src={Logo} alt="Logo" className="w-31 h-20 rounded-full" />
        </a>
